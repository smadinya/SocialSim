...
const COLD: Record<string, string> = {
  ...
  SpreadRumor:
    "Since you're asking, {target} — there's plenty being said about {subject}, and none of it is kind.",
  RevealSecret:
...
const WARM: Record<string, string> = {
  ...
  SpreadRumor:
    "I wouldn't say this to anyone but you, {target} — people are talking about {subject}.",
  RevealSecret:
